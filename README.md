...
- **Show, don't overwhelm.** Use raw code blocks and CLI outputs for technical substance. Long code blocks (>30 lines) are automatically wrapped in a collapsible `<details>` element to maintain page flow while keeping technical evidence accessible.
