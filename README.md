...
- **Show, don't overwhelm.** Use raw code blocks and CLI outputs for technical substance. The site's layout automatically manages long code blocks (>15 lines) with an integrated "Show More" toggle to maintain page flow while keeping technical evidence accessible.
