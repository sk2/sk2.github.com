...
NetVis is a library-first network topology visualization engine for Rust. It transforms network topologies into clear, information-dense visualizations using layout algorithms that minimize edge crossings, bundle related connections, and respect hierarchical structure.
